...
class UpcomingDataSource(var query: String, var apiService: MovieApiService) :
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, Trending> {
        ...
        return try {
            val result = apiService.getMoviesType(query, commonParams)
            Log.e("UpcomingMoviesViewModel DataSource", "" + result)
            ...
            Log.e("UpcomingMoviesViewModel Exception", "" + e.toString())
            LoadResult.Error(e)
        }
